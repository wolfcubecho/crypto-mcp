...
async function main() {
  ...
  out.sort((a,b)=>{ const ra = score[a.rating]??0, rb = score[b.rating]??0; if (rb!==ra) return rb-ra; const ma = a.pct24h?Math.abs(a.pct24h):0, mb = b.pct24h?Math.abs(b.pct24h):0; return mb-ma; });
